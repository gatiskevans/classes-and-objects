<?php
    ...
    class Product {
        ...
        function __construct(string $name, float $price_at_start, int $amount_at_start){
            $this->name = $name;
            $this->price_at_start = number_format($price_at_start, 2);
            $this->amount_at_start = $amount_at_start;
        }

        function print_product(): string {
